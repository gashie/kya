              ...
              <Col lg="4">
                <div className="card-inner-group">
                  <div className="card-inner">
                    ...
                    <p>Kindly take a moment to Update your records with us.</p>
                  </div>
                  <div className="card-inner">
                    <ul className="list list-step">
                    <li className="list-step-current">Welcome Notes</li>
                  ...
                  <div className="card-inner">
                    <div className="align-center gx-3">
                      ...
                      <div className="flex-item">
                        <span className="sub-text sub-text-sm text-soft">0/3 Completed</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="card-inner card-inner-lg h-100">
                  <div className="align-center flex-wrap flex-md-nowrap g-3 h-100">
                    ...
                    <BlockContent>
                      ...
                      {/* <p>
                      Kindly take a moment to Update your records with us
                      </p> */}
                      <ul className="list list-sm list-checked">
                        <li>
                        Click on Ghana Card Update button to update only your GH card details with us
                        </li>
                        <li>
                        Click on Full Customer Update button to update full customer details with us
                        </li>
                      </ul>
                      ...
                      <Row className="g-4">
                      <Col lg="6">
                      <Link to={`${process.env.PUBLIC_URL}/kyc/account`} className="link link-sm">
                      ...
                      <Col lg="6">
                      <Link  to={{ pathname: "https://calweb.caleservice.net/customerupdate" }} target="_blank" className="link link-sm">
