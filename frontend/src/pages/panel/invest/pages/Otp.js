...
import { VerifyOtp } from "../../../../appRedux/actions/CustomerAction";
import { VERIFY_OTP_RESET } from "../../../../appRedux/actions/type";
...
const CustomerOtp = () => {
  ...
  const VerifyOtptate = useSelector((state) => state.verifyCustomerOtp);

  const { verifyloading, verifyerror, verify } = VerifyOtptate;
  ...
  const onFormSubmit = (submitData) => {
    ...
    dispatch(VerifyOtp(submittedData));
    reset();
    resetForm()
  };
              ...
              <Col lg="4">
                <div className="card-inner-group">
                  ...
                  <div className="card-inner">
                   ...
                   <li className="list-step-current">Verify Otp</li>
                      <li>Verify Ghana Card And Account</li>
                  ...
                  <div className="card-inner">
                    <div className="align-center gx-3">
                      ...
                      <div className="flex-item">
                        <span className="sub-text sub-text-sm text-soft">2/3 Completed</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <Col lg="8">
                <div className="card-inner card-inner-lg h-100">
                  ...
                  <div className="block-image w-200px flex-shrink-0 order-first order-md-last">
                    ...
                    <BlockContent>
                      <BlockHeadContent>
                        <h4>Verify One Time Password(OTP) </h4>
                        {/* <span className="sub-text sub-text-sm text-soft">2 minutes</span> */}
                      </BlockHeadContent>
                      <p>
                      OTP to validate your account has been sent to your email and phone number registered on your account.
                      </p>
              ...
              <Row className="g-4">
                <Col lg="12">
                  ...
                  <FormGroup className="form-group">
                    ...
                    <div className="form-control-wrap">
                        ...
                        type="number"
                        name="otp"
                        onChange={e => setFormData({ ...formData, otp: e.value })}
                ...
                <BlockContent className="flex-shrink-0">
                   ...
                   {/* {verifyloading ? <Spinner size="sm" color="yellow" m /> : <Button color="white" size="lg" className="btn-block  btn-outline-warning btn-dim"   outline type="submit">Verify
                     ...
                     <Button size="lg" className="btn-block  btn-outline-warning btn-dim" type="submit" disabled={verifyloading} color="warning">
